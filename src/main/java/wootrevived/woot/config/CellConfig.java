...
public class CellConfig {
    public static ModConfigSpec.ConfigValue<Integer> COPPER_CAPACITY;
    public static ModConfigSpec.ConfigValue<Integer> IRON_CAPACITY;
    public static ModConfigSpec.ConfigValue<Integer> GOLD_CAPACITY;
    public static ModConfigSpec.ConfigValue<Integer> DIAMOND_CAPACITY;
    public static ModConfigSpec.ConfigValue<Integer> NETHERITE_CAPACITY;
