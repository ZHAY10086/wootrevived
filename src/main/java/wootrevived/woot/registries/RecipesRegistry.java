...
public class RecipesRegistry {
    ...
    public static final RegistryObject<RecipeType<StygianAnvilRecipe>> ANVIL_RECIPE_TYPE = RECIPE_TYPES.register(BlocksRegistry.STYGIAN_ANVIL_TAG, () -> RecipeType.simple(Woot.location(BlocksRegistry.STYGIAN_ANVIL_TAG)));
    ...
    public static final RegistryObject<RecipeType<DyeLiquifierRecipe>> DYE_LIQUIFIER_RECIPE_TYPE = RECIPE_TYPES.register(BlocksRegistry.DYE_LIQUIFIER_TAG, () -> RecipeType.simple(Woot.location(BlocksRegistry.DYE_LIQUIFIER_TAG)));
    ...
    public static final RegistryObject<RecipeType<FluidInfuserRecipe>> FLUID_INFUSER_RECIPE_TYPE = RECIPE_TYPES.register(BlocksRegistry.FLUID_INFUSER_TAG, () -> RecipeType.simple(Woot.location(BlocksRegistry.FLUID_INFUSER_TAG)));
    ...
    public static final RegistryObject<RecipeType<ItemInfuserRecipe>> ITEM_INFUSER_RECIPE_TYPE = RECIPE_TYPES.register(BlocksRegistry.ITEM_INFUSER_TAG, () -> RecipeType.simple(Woot.location(BlocksRegistry.ITEM_INFUSER_TAG)));
    ...
    public static final RegistryObject<RecipeType<EnchantedLiquifierRecipe>> ENCHANTED_LIQUIFIER_RECIPE_TYPE = RECIPE_TYPES.register(BlocksRegistry.ENCHANTED_LIQUIFIER_TAG, () -> RecipeType.simple(Woot.location(BlocksRegistry.ENCHANTED_LIQUIFIER_TAG)));
}
